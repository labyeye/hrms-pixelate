...
async function seedTestUser() {
  try {
    ...
    const company = await Company.create({
      ...
      phone: "+91 98765 43210",
      password: "CompanyPass@123", // Will be hashed automatically
      industry: "Technology",
      website: "https://testenterprise.com",
      gstNumber: "27AABCT1234A1Z5",
      panNumber: "AAAAA0000A",
      status: "active", // Active status since payment is done
      createdBy: user._id,
    });
    console.log("✅ Company created:", company._id);

    // Create Subscription (Enterprise Plan - 200rs/month)
    const subscription = await Subscription.create({
      company: company._id,
      plan: "enterprise", // 200rs plan
      monthlyPrice: 200,
