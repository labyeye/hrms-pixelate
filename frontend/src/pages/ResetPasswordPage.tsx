          ...
          {done ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="block text-xs font-black text-black uppercase tracking-wider mb-1.5">New Password</label>
                  <div className="flex border-2 border-black focus-within:border-[#024BAB] transition-colors">
                    <input
                      ...
                      autoFocus
                    />
                    <button type="button" onClick={() => setShowPw(!showPw)} className="px-3 border-l-2 border-black hover:bg-gray-50">
                      {showPw ? <EyeOff className="w-4 h-4 text-black" /> : <Eye className="w-4 h-4 text-black" />}
                    </button>
                  </div>
                </div>

                <div>
                  <label className="block text-xs font-black text-black uppercase tracking-wider mb-1.5">Confirm Password</label>
                  <input
                    type={showPw ? "text" : "password"}
                    value={confirm}
              ...
              <div className="mt-6 text-center">
                <Link to="/login" className="text-sm font-black text-[#024BAB] hover:underline">Back to login</Link>
              </div>
            </>
          )}
        </div>
